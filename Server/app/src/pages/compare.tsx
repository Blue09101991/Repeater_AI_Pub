  ...
  return (
    <>
      <div className="flex flex-col h-full">
        ...
        <div className="flex flex-grow flex-col font-display min-h-0 min-w-0" style={{ marginTop: '10px' }}>
          <div className="flex flex-row space-x-4 flex-grow mx-2 md:ml-5 lg:ml-5 min-h-0 min-w-0" style={{ marginTop: '10px', marginBottom: '90px' }}>
