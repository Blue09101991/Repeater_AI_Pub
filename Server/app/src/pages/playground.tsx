                      ...
                      <div key={historyItem.timestamp}>
                        <div
                          ...
                          className={`[&>div:nth-child(2)]:hover:w-[7px]
                              ...
                              rounded-sm rounded-sm relative flex flex-row p-4 font-bold text-sm cursor-pointer click:bg-slate-300 dark:hover:bg-slate-200  ${isSelectedHistoryItem
                              ? "bg-slate-200"
                              : "hover:bg-slate-100"
                            }`}
                        >
...
const PromptCompletionEditor = ({ showDialog }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex space-x-2 mb-8" style={{ marginBottom: '100px' }}>
        {generating && (
          <TooltipProvider>
        ...
        <TooltipProvider>
          ...
          <Tooltip delayDuration={100}>
            ...
            <div className="flex basis-full my-4 lg:mb-0 space-x-2">
...
export default function Playground() {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex flex-grow flex-col font-display min-h-0 min-w-0 ml-5" style={{ marginTop: '10px' }}>
        <div className="flex flex-row space-x-4 flex-grow mr-5 min-h-0 min-w-0" style={{ marginTop: '10px', overflowY: 'scroll' }}>
          {
            historyContext.show ? (
