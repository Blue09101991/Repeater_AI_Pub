...
const ProviderSearchModels = ({
  ...
  return (
    <>
      ...
      <div>
        <div className="min-h-[420px] w-full border rounded-md mt-3">
          <div className="p-2">
            {searchResults()}
          </div>
        </div>
  ...
  const providersButtons = () =>
    Object.entries(providers).map(([name, _]) =>
      <React.Fragment key={name}>
        <button
          className={`block w-full text-left px-2 py-1 border-l-2 ${providerName === name ? "border-blue-500" : "border-transparent"
            }`}
  ...
  return (
    <>
      <div className="flex flex-col h-full">
        {/* <NavBar tab="settings" /> */}
        <div className="flex flex-1 flex-col font-display flex-grow overflow-show" style={{ marginTop: '10px' }}>
          <div className="max-h-[100%] lg:flex-grow grid gap-6 grid-cols-6 mx-1 lg:mx-5 flex flex-row" style={{ marginTop: '10px', marginBottom: '90px' }}>
